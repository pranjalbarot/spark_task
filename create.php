...
<footer class="text-center mt-5 py-2 bg-dark text-light">
          ...
          <div class="symbol">
                 ...
                 <a href="" onmouseover="this.style.color='red'" onmouseout="this.style.color='aqua'" ><i class="fab fa-github fa-2x"></i></a>
                  <a href="" onmouseover="this.style.color='red'" onmouseout="this.style.color='aqua'"><i class="fab fa-linkedin fa-2x"></i></a>
                  <a href="" onmouseover="this.style.color='red'" onmouseout="this.style.color='aqua'"><i class="fab fa-instagram fa-2x"></i></a>
         </div>    
</footer>
